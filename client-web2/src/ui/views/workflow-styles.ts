...
export const workflowStyles = html`
  <style>
    /* Metrics cards row */
    .wf-metrics-row {
      display: grid;
    ...
    .wf-md pre {
      background: var(--bg-deeper, rgba(0, 0, 0, 0.2));
      border-radius: 6px;
      padding: 8px 10px;
      overflow-x: auto;
      font-size: 12px;
    ...
    .wf-md code {
      background: var(--bg-deeper, rgba(0, 0, 0, 0.15));
      padding: 1px 4px;
      border-radius: 3px;
      font-size: 0.9em;
    }
    ...
    .wf-modal {
      ...
      animation: wfSlideUp 0.2s cubic-bezier(0.16, 1, 0.3, 1);
    }
    @keyframes wfSlideUp {
      from {
    ...
    .wf-modal-close-btn:hover {
      background: var(--bg-deeper, rgba(255, 255, 255, 0.08));
