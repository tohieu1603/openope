...
export function renderRegister(props: RegisterProps) {
  ...
  const handleSubmit = (e: Event) => {
    ...
    const nameInput = form.querySelector('operis-input[name="name"]') as HTMLElement & {
      value?: string;
    };
    const emailInput = form.querySelector('operis-input[type="email"]') as HTMLElement & {
      value?: string;
    };
    const passwordInput = form.querySelector('operis-input[type="password"]') as HTMLElement & {
      value?: string;
    };
    const confirmInput = form.querySelector('operis-input[name="confirm"]') as HTMLElement & {
      value?: string;
    };
