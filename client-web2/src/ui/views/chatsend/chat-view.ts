  ...
  if (status.active) {
    return html`
      <div class="compaction-indicator compaction-indicator--active" role="status" aria-live="polite">
        ${icons.loader} Đoạn chat quá dài, đang tóm tắt lại...
      </div>
    `;
  }
...
export function renderChat(props: ChatProps) {
  ...
  const composePlaceholder = props.connected
    ? hasAttachments
      ? "Thêm tin nhắn hoặc dán ảnh..."
      : "Nhập tin nhắn... (↩ gửi, Shift+↩ xuống dòng)"
    : "Kết nối gateway để bắt đầu chat…";
        ...
        <div class="chat-compose__box">
          ...
          <div class="chat-compose__toolbar">
            <div class="chat-compose__toolbar-left">
              <label class="btn--icon chat-compose__upload-label" title="Tải ảnh lên">
                ${icons.image}
                <input
                  type="file"
                  accept="image/*"
            ...
            <div class="chat-compose__toolbar-right">
              ...
              <button
                class="chat-compose__send ${!props.connected ? "disabled" : ""}"
                ?disabled=${!props.connected}
                @click=${props.onSend}
