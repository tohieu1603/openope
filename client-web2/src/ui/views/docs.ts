...
const categories = [
  {
    ...
    items: [
      {
        title: "Bắt Đầu Nhanh",
        description: "Hướng dẫn cài đặt và sử dụng cơ bản",
        icon: "zap",
        slug: "bat-dau-nhanh",
      },
      {
        title: "Tổng Quan Hệ Thống",
        description: "Kiến trúc và cách hoạt động",
        icon: "cpu",
  ...
  },
  {
    ...
    items: [
      {
        title: "Chat và Hỏi Đáp",
        description: "Gửi tin nhắn và nhận phản hồi AI",
        icon: "messageSquare",
        slug: "chat-va-hoi-dap",
      },
      {
        title: "Kiểm Tra Máy Tính",
        description: "Giám sát tình trạng hệ thống",
        icon: "monitor",
        slug: "kiem-tra-may-tinh",
      },
      {
        title: "Quản Lý File",
  ...
  },
  {
    ...
    items: [
      {
        title: "Tổng Quan Trình Duyệt",
        description: "Giới thiệu tính năng trình duyệt",
        icon: "book",
        slug: "tong-quan-trinh-duyet",
      },
      {
        title: "Chrome Extension",
        description: "Cài đặt và sử dụng extension",
        icon: "puzzle",
        slug: "chrome-extension",
      },
      {
        title: "Điều Khiển Trình Duyệt",
        description: "Tự động hóa thao tác trình duyệt",
        icon: "code",
        slug: "dieu-khien-trinh-duyet",
      },
      {
        title: "Ví Dụ Thực Tế",
        description: "Các ví dụ sử dụng trình duyệt",
        icon: "fileText",
        slug: "vi-du-trinh-duyet",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Hẹn Giờ và Nhắc Nhở",
        description: "Đặt lịch và nhắc nhở tự động",
        icon: "clock",
        slug: "hen-gio-va-nhac-nho",
      },
      {
        title: "Kiểm Tra Định Kỳ",
        description: "Tự động kiểm tra theo lịch",
        icon: "calendar",
        slug: "kiem-tra-dinh-ky",
      },
      {
        title: "Làm Việc Lớn Ở Nền",
        description: "Chạy tác vụ nặng nền tảng",
        icon: "cpu",
        slug: "lam-viec-lon-o-nen",
      },
      {
        title: "Ví Dụ Thực Tế",
        description: "Các ví dụ tự động hóa",
        icon: "fileText",
        slug: "vi-du-tu-dong-hoa",
      },
    ],
  },
] as const;
