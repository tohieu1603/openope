 ...
 */
export async function getRangeUsage(start: string, end: string): Promise<RangeUsageResponse> {
  try {
 ...
 */
export async function getUsageHistory(limit = 50, offset = 0): Promise<HistoryResponse> {
  try {
